...
class ExodusReader:
    ...
    def entity_set_ids(self, entity_type: EntityType) -> NDArray[np.int64]: ...
    ...
    def global_variable_values(self, var_name: str) -> NDArray[np.float64]: ...
    def nodal_variable_values(self, var_name: str, time_step: int) -> NDArray[np.float64]: ...
    def element_variable_values(self, var_name: str, block_id: int, time_step: int) -> NDArray[np.float64]: ...
    def variable_values(
        self,
        entity_type: EntityType,
        var_name: str,
...
class ExodusWriter:
    ...
    def put_connectivity(
        ...
        entity_type: EntityType,
        block_id: int,
        connectivity: Union[List[int], NDArray[np.int64]]
    ) -> None: ...
    ...
    def put_nodal_variable_values(
        ...
        time_step: int,
        var_name: str,
        values: Union[List[float], NDArray[np.float64]]
    ) -> None: ...
...
class BlockBuilder:
    ...
    def connectivity(self, conn: Union[List[int], NDArray[np.int64]]) -> BlockBuilder: ...
    def attributes(self, attrs: Union[List[float], NDArray[np.float64]]) -> BlockBuilder: ...
